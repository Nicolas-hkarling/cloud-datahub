...
import com.sap.cxai.constants.CxaioccaddonConstants;



/**
 * This is the extension manager of the cxaioccaddon extension.
 */
public class CxaioccaddonManager extends GeneratedCxaioccaddonManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(CxaioccaddonManager.class.getName());
	 ...
	 */
	public CxaioccaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CxaioccaddonManager called.");
		}
	}
	 ...
	 */
	public static CxaioccaddonManager getInstance()
	{
		return (CxaioccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CxaioccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CxaioccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CxaioccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
