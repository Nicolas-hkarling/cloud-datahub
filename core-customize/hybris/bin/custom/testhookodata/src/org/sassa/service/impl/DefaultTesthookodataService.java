...
public class DefaultTesthookodataService implements TesthookodataService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTesthookodataService.class);
	...
	{
		return DefaultTesthookodataService.class.getResourceAsStream("/testhookodata/sap-hybris-platform.png");
	}
